...
const {APP_LANGUAGES} = require('../../../src/config/constants');
...
module.exports = {
  ...
  actions: data => {
    ...
    const actions = [
      ...
      {
        type: 'add',
        path: '../../src/modules/{{properCase name}}/{{properCase defaultName}}Context/index.js',
        templateFile: './module/context.js.hbs',
        abortOnFail: true,
      },
      {
        type: 'add',
        path: '../../src/modules/{{properCase name}}/{{properCase defaultName}}Context/{{camelCase defaultName}}Reducer.js',
        templateFile: './module/reducer.js.hbs',
        abortOnFail: true,
      },
      {
        type: 'add',
        path: '../../src/modules/{{properCase name}}/{{properCase defaultName}}Context/reducer.test.js',
    ...
    if (data.wantMessages) {
      APP_LANGUAGES.forEach(lang => {
        actions.push({
          type: 'add',
          path: `../../public/locales/${lang}/{{ camelCase defaultName }}.json`,
